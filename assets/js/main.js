(() => {
  ...
  function initPage() {
    ...
    tl.set(".container", { display: "block", opacity: 1 })
      ...
      .fromTo(".wax", { opacity: "1", y: 0, duration: 1.5 }, { opacity: "0", y: 120, duration: 1 },)
      .to(".group-name", { opacity: "0", y: -120, duration: 1.5 }, "<")
  ...
  function initTimeline() {
    ...
    items.forEach((item, index) => {
      ...
      const time = item.querySelector(".time-and-title");
